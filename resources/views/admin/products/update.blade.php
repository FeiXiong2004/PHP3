        ...
        <form action="{{ route('admin.books.update',$book->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="thumbnail" name="thumbnail" value="{{ $book->thumbnail ?? '' }}" 
                    placeholder="Enter book thumbnail URL">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control" id="publication" name="publication" value="{{ $book->publication ?? '' }}">
            </div>
            <div class="mb-3">
                <label for="price" class="form-label">Price</label>
                <input type="number" class="form-control" id="price" name="price" placeholder="Enter book price" value="{{ $book->price ?? '' }}">
            </div>
            <div class="mb-3">
